// Source: React Bits PixelBlast component.
// License notice is included in ./LICENSE.md.
...
const PixelBlast: React.FC<PixelBlastProps> = ({
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const pointerTarget = globalPointer ? window : renderer.domElement;
      const handlePointerDown: EventListener = event => onPointerDown(event as PointerEvent);
      const handlePointerMove: EventListener = event => onPointerMove(event as PointerEvent);
      ...
      threeRef.current.cleanupPointer = () => {
